...
@Route("page-editor")
@Menu(order = 0, icon = LineAwesomeIconUrl.EDIT)
public class PageEditorView extends Main {
    ...
    private Section createSidebar() {
        return createSidebar( "0001", "0002"); 
    }

    private Section createSidebar(String viewCode  , String editCode) {
        ...
        dl.addClassNames(Display.FLEX, FlexDirection.COLUMN, Gap.LARGE, Margin.Bottom.SMALL, Margin.Top.NONE,
                ...
                dl.add(
                    createItem("Owner", "My Name"),
                    createItem("Created", "2021-08-14 14:48"),
                    createItem("Last modified", "2021-08-14 14:50"),
                    createBadgeItem("Status", "Draft"),
                    createBadgeItem("View Code", viewCode),
                    createBadgeItem("Edit Code", editCode)
            );
    
            // Create and attach the hidden download link
