...
public class WebSocketConfig implements WebSocketConfigurer {
    ...
    public WebSocketConfig(DocumentWebSocketHandler documentWebSocketHandler) {
        ...
        logger.info("WebSocketConfig initialized with handler: {}", documentWebSocketHandler.getClass().getName());
    }

    @Override
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        String path = "/collaborate/{documentId}";
        logger.info("Registering WebSocket handler at path: {}", path);
        logger.info("Server port: {}, Context path: '{}'", serverPort, contextPath);
        
        registry.addHandler(documentWebSocketHandler, path)
    ...
    public void handleContextRefresh(ContextRefreshedEvent event) {
        ...
        logger.info("WebSocket should be available at: ws://localhost:{}{}/collaborate/{{documentId}}",
